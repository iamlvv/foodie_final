...
<div class='lg:flex lg:flex-1 lg:justify-center lg:gap-20 bg-blue-200 h-auto'>
    <div class='lg:m-10 md:ml-0'>
        ...
        <div class='mt-10 lg:text-right md:text-center'>
            <button class='bg-black text-white pt-2 pb-3 px-6 rounded-3xl font-bold text-2xl hover:drop-shadow-md transition ease-in hover:bg-white hover:text-black'><a href="./allProducts.php" class="">Start Shopping</a></button>
        </div>
    </div>
