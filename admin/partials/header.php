        ...
        <div class="bg-black h-full">
            <ul class="text-right h-full  float-right pr-10">
                <li class="inline-block font-bold bg-black text-white w-24 py-2 my-3 text-center">
                    <a href="index.php" class=" hover:text-black hover:bg-white rounded-full px-3 py-2 transition ease-in">Home</a>
                </li>
                <li class="inline-block font-bold bg-black text-white w-24 py-2 text-center">
                    <form method="POST">
                        <input type="submit" name="logout" class=" hover:text-black hover:bg-white rounded-full px-3 py-2 transition ease-in cursor-pointer" value="Log out"/>
                    </form>
                </li>
            </ul>
        </div>
